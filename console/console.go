...
func (c *Console) AutoCompleteInput(line string, pos int) (string, []string, string) {
	...
	// E.g. in case of nested lines pls.getBalance(pls.coinb<tab><tab>
	start := pos - 1
	for ; start > 0; start-- {
...
func (c *Console) Welcome() {
	...
	c.jsre.Run(`
		...
		console.log("coinbase: " + pls.coinbase);
		console.log("at block: " + pls.blockNumber + " (" + new Date(1000 * pls.getBlock(pls.blockNumber).timestamp) + ")");
