...
func newTester(t *testing.T, confOverride func(*pls.Config)) *tester {
	...
	ethConf := &eth.Config{
		Genesis: core.DeveloperGenesisBlock(15, common.Address{}, common.HexToAddress(testAddress), params.DefaultStaminaConfig),
		Miner: miner.Config{
	...
	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return pls.New(ctx, ethConf) }); err != nil {
