...
!define HELPURL "https://github.com/Onther-Tech/plasma-evm/issues"
!define UPDATEURL "https://github.com/Onther-Tech/plasma-evm/releases"
!define ABOUTURL "https://github.com/Onther-Tech/plasma-evm#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:30305)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:30305)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:30305)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30305)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" 30305 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30305)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30305 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30305)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30305 "" ""
