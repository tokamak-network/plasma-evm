...
func ReadInvalidExitReceiptsLookupEntry(db ethdb.Reader, fork uint64, num uint64) (common.Hash, uint64, []uint64) {
...
func WriteInvalidExitReceiptsLookupEntry(db ethdb.KeyValueWriter, fork uint64, hash common.Hash, num uint64, indices []uint64) {
...
func DeleteInvalidExitReceiptsLookupEntry(db ethdb.KeyValueWriter, fork uint64, num uint64) {
	db.Delete(invalidExitReceiptsLookupKey(fork, num))
}

// ReadInvalidExitReceipts retrieves all the invalid exit receipts.
func ReadInvalidExitReceipts(db ethdb.Reader, fork uint64, num uint64, config *params.ChainConfig) map[uint64]*types.Receipt {
