...
func ReadRootchainBlockNumber(db ethdb.Reader) *uint64 {
...
func WriteRootchainBlockNumber(db ethdb.KeyValueWriter, number uint64) {
...
func WriteEpochEnv(db ethdb.KeyValueWriter, e *epoch.EpochEnvironment) {
