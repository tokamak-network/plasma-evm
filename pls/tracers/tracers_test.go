...
import (
	...
	"github.com/Onther-Tech/plasma-evm/tests"
)
...
var makeTest = function(tx, rewind) {
  ...
  var block   = pls.getBlock(pls.getTransaction(tx).blockHash);
  var genesis = pls.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.pls.config;
  ...
  console.log(JSON.stringify({
    ...
    input:  pls.getRawTransaction(tx),
    result: result,
  }, null, 2));
}
*/
